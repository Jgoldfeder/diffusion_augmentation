...
class NerfAugmentationManager:
    ...
    def generate_augmentations(self, image_paths):
        """
        Generate augmentations for all images in a directory
        Args:
            image_paths: List[str], paths to input images
        Returns:
            dict: Dictionary mapping output file paths to augmented images
        """
        augmentations = {}
        count = 0
        ...
        for image_path in image_paths:
            ...
            augmentations[image_path] = augmented_images[0]
