...
class Machine0:
    def __init__(self):
        self.name = "machine_0"
        self.aug_dir = "/data/puma_envs/control_augmented_images_food101_512"
...
def get_full_dataset_commands_food_scratch():
    commands = []
...
commands = get_full_dataset_commands_food_scratch()
