...
class Machine0:
    def __init__(self):
        self.name = "machine_0"
        self.aug_dir = "/home/ubuntu/control_augmented_images_aircraft_512"
        #self.aug_dir = "/home/pat/diffusion_augmentation/control_augmented_images_aircraft_512"
        self.data_dir = "torch/aircraft"
...
def get_full_dataset_commands_aircraft_scratch():
    ...
    seeds = [21]#[10,20,30]    
    models= ['vit_base_patch8_224']#["deit_tiny_distilled_patch16_224","poolformer_s24","mobilenetv3_small_100","densenet121"]#vit_base_patch8_224
    #models= ['beit_base_patch16_224']#["efficientnet_b2","visformer_tiny","swin_s3_tiny_224","mixer_s16_224"]#["resnet50",vit_base_patch8_224]
    ...
    for model in models:
        for recipe in recipes:
            for seed in seeds:            
                ...
                commands.append([model,exp_name,experiment,recipe,shot,variation,way_str +"  --switch --switch-epoch 40 ",exp_repeats,seed])
