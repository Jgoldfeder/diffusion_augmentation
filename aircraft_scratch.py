...
# num_processes = 8
machine_0 = Machine0()
for i in [3,3,3,3,3,2,2,2,2,2]: #+ [0,1,2,3,4,5,6,7]:
    queue.put(GPU(machine_0,i))
num_processes = 10
...
def get_full_dataset_commands_aircraft_scratch():
    ...
    seeds = [21]#[10,20,30]    
    models= ['vit_base_patch8_224',"deit_tiny_distilled_patch16_224","poolformer_s24","mobilenetv3_small_100","densenet121"]
