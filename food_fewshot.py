...
class Machine0:
    def __init__(self):
        self.name = "machine_0"
        self.aug_dir = "/data/puma_envs/control_augmented_images_food101_512fewshot"
        self.data_dir = "/data/torch/food101"
...
def get_fewshot_commands_food_pretrain_switch():
    commands = []
        ...
        for seed in seeds:
            for way in ways:
                if way=="all":
                    way_str = ""
                if way=="5":
                    way_str = " --classes 0 5 10 11 21"  
                if way=="10":
                    way_str= " --classes 0 5 10 11 21 14 15 76 88 90" 
                for shot in shots:
...
commands = get_fewshot_commands_food_pretrain_switch()
