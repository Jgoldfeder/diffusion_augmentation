...
class Machine0:
    def __init__(self):
        self.name = "machine_0"
        self.aug_dir = "/data/puma_envs/no_control_augmented_images_aircraft"
...
def get_fewshot_commands_aircraft_pretrain_sunswitch():
    commands = []
...
commands = get_fewshot_commands_aircraft_pretrain_sunswitch()
