...
class Machine0:
    def __init__(self):
        ...
        self.aug_dir = "/data/puma_envs/control_augmented_images_pets_512fewshot"
...
def get_fewshot_commands_dogs_scratch():
    commands = []
...
def get_fewshot_commands_pets_pretrain_sunswitch():
    commands = []
...
def get_fewshot_commands_cars_pretrain_switch():
    commands = []
